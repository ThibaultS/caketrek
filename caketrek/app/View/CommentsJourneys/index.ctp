<div class="commentsJourneys index">
	<h2><?php echo __('Comments Journeys'); ?></h2>
	...
	<?php
	foreach ($commentsJourneys as $commentsJourney): ?>
	<tr>
		<td><?php echo h($commentsJourney['CommentsJourney']['id']); ?>&nbsp;</td>
		<td><?php echo h($commentsJourney['CommentsJourney']['comment_id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($commentsJourney['Journey']['name'], array('controller' => 'journeys', 'action' => 'view', $commentsJourney['Journey']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $commentsJourney['CommentsJourney']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $commentsJourney['CommentsJourney']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $commentsJourney['CommentsJourney']['id']), null, __('Are you sure you want to delete # %s?', $commentsJourney['CommentsJourney']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
