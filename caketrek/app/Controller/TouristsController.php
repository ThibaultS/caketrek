 ...
 */
	public function add() {
		...
		$comments = $this->Tourist->Comment->find('list');
		$journeys = $this->Tourist->Journey->find('list');
		/*$tourists = $this->Tourist->Tourist->find('list');*/
		$this->set(compact('users', 'comments', 'journeys', 'tourists'));
	}
